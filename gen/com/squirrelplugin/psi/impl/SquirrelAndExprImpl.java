...
public class SquirrelAndExprImpl extends SquirrelExprImpl implements SquirrelAndExpr {

  public SquirrelAndExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitAndExpr(this);
