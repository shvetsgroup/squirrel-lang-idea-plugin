...
public class SquirrelAssignExprImpl extends SquirrelExprImpl implements SquirrelAssignExpr {

  public SquirrelAssignExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitAssignExpr(this);
