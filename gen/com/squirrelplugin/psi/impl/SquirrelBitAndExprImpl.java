...
public class SquirrelBitAndExprImpl extends SquirrelExprImpl implements SquirrelBitAndExpr {

  public SquirrelBitAndExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitBitAndExpr(this);
