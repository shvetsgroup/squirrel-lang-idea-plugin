...
public class SquirrelBitOrExprImpl extends SquirrelExprImpl implements SquirrelBitOrExpr {

  public SquirrelBitOrExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitBitOrExpr(this);
