...
public class SquirrelBitXorExprImpl extends SquirrelExprImpl implements SquirrelBitXorExpr {

  public SquirrelBitXorExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitBitXorExpr(this);
