...
public class SquirrelCommaExprImpl extends SquirrelExprImpl implements SquirrelCommaExpr {

  public SquirrelCommaExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitCommaExpr(this);
