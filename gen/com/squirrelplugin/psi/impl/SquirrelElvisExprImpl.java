...
public class SquirrelElvisExprImpl extends SquirrelExprImpl implements SquirrelElvisExpr {

  public SquirrelElvisExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitElvisExpr(this);
