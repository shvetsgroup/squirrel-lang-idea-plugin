...
public class SquirrelInExprImpl extends SquirrelExprImpl implements SquirrelInExpr {

  public SquirrelInExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitInExpr(this);
