...
public class SquirrelOrExprImpl extends SquirrelExprImpl implements SquirrelOrExpr {

  public SquirrelOrExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SquirrelVisitor) ((SquirrelVisitor)visitor).visitOrExpr(this);
