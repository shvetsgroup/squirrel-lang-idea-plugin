...
import com.sqide.sqdbg.breakpoint.DlvBreakpointProperties;
import com.sqide.sqdbg.breakpoint.DlvBreakpointType;
import com.sqide.sqdbg.protocol.DlvApi;
...
import static com.sqide.sqdbg.protocol.DlvApi.*;
...
public final class DlvDebugProcess extends DebugProcessImpl<RemoteVmConnection> implements Disposable {
  ...
  private static class MyEditorsProvider extends XDebuggerEditorsProviderBase {
    ...
    protected PsiFile createExpressionCodeFragment(@NotNull Project project,
                                                   ...
                                                   boolean isPhysical) {
      return PsiFileFactory.getInstance(project).createFileFromText("sqdbg-debug.txt", PlainTextLanguage.INSTANCE, text);
    }
  }
