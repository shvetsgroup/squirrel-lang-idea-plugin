...
public class SquirrelWrappingProcessor {
    ...
    public SquirrelWrappingProcessor(ASTNode node, CommonCodeStyleSettings settings) {
        myNode = node;
        mySettings = settings;
    }
...
//        }
//
//        if (elementType == REFERENCE_EXPRESSION && childType == DOT) {
//            return Wrap.createWrap(WrapType.NORMAL, true);
//        }
...
//    }
    ...
    private static boolean isNotFirstInitializer(ASTNode child) {
        ...
        while ((prev = prev.getTreePrev()) != null) {
            ...
            if (!isSemicolon(prev) && !COMMENTS.contains(prev.getElementType())) {
                isFirst = true;
            }
        }
        return isFirst;
